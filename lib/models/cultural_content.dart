class CulturalContentItem {
  final String id;
  final String category; // 'Verse', 'Song', 'Proverb', 'Rhyme', 'Story'
  final String title;
  ...
  final String languageCode; // 'sa', 'hi', 'te', 'ta', 'as', 'bn', 'en'
  ...
  factory CulturalContentItem.fromJson(Map<String, dynamic> json) => CulturalContentItem(
        id: json['id'] ?? '',
        ...
        source: json['source'] ?? 'Traditional Oral Memory',
        ...
        languageCode: json['languageCode'] ?? 'sa',
      );
}
